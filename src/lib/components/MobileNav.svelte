...
<nav
	class="flex h-12 items-center justify-between border-b bg-app-surface px-3 dark:border-gray-800 dark:bg-app-surface/70 md:hidden"
>
	<button
		type="button"
...
<nav
	class="fixed inset-0 z-30 grid max-h-screen grid-cols-1 grid-rows-[auto,auto,1fr,auto] bg-app-bg {isOpen
		? 'block'
		: 'hidden'}"
>
