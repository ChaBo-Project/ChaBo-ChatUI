...
<button
	class="btn relative h-8 rounded-lg border bg-app-surface px-3 py-1 text-sm text-gray-500 shadow-sm hover:bg-app-surface/70 dark:border-gray-600 dark:text-gray-300 {classNames}"
>
	<input
		class="absolute w-full cursor-pointer opacity-0"
		type="file"
